...
void ADC_voidInit(void)
{
	...
	//DIO_u8SetPortDirection(DIO_u8_PORTA,DIO_u8_INPUT);
...
{   /*to cheek Adc not busy to conversion or read any other channel */
...
/* Returns:Local_u8ErrorState 	                                				    **/
/* Desc:This Function reads a specific ADC Channel						       	**/
/*********************************************************************************/
/* Copy_u8ChannelNum Options: 	ADC_CHANNEL_0 --> ADC_CHANNEL_7					**/
/* *Copy_pvCallBackFunctionPtr: Address of the Function to be executed			**/
/*********************************************************************************/
u8 ADC_u16ReadAsynchronus(u8 Copy_u8ChannelNum, void (*Copy_pvCallBackFunctionPtr)(void))
{
